...
class _EditarCitaWidgetState extends State<EditarCitaWidget> {
  ...
  void initState() {
    ...
    _model.txtCitaIdTextController ??=
        TextEditingController(text: widget.paramCitas?.citaID.toString());
    _model.txtCitaIdFocusNode ??= FocusNode();
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .txtCitaIdTextController,
                                              focusNode:
                                                  _model.txtCitaIdFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              ...
                                              cursorColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              validator: _model
                                                  .txtCitaIdTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                    ...
                                    Padding(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.txtNombreMascotaFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (confirmDialogResponse) {
                                            ...
                                            await widget.paramCitas!.reference
