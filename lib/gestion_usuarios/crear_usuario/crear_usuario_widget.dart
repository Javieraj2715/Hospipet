...
class _CrearUsuarioWidgetState extends State<CrearUsuarioWidget> {
  ...
  void initState() {
    ...
    _model.txtConfirmarPassTextController ??= TextEditingController();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: 250.0,
                    child: TextFormField(
                      controller: _model.txtConfirmarPassTextController,
                      focusNode: _model.txtConfirmarPassFocusNode,
                      autofocus: false,
                      obscureText: !_model.txtConfirmarPassVisibility,
                      decoration: InputDecoration(
                        isDense: true,
                        ...
                        suffixIcon: InkWell(
                          onTap: () => safeSetState(
                            () => _model.txtConfirmarPassVisibility =
                                !_model.txtConfirmarPassVisibility,
                          ),
                          focusNode: FocusNode(skipTraversal: true),
                          child: Icon(
                      ...
                      cursorColor: FlutterFlowTheme.of(context).primaryText,
                      validator: _model.txtConfirmarPassTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
