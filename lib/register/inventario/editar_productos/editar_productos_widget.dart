...
class EditarProductosWidget extends StatefulWidget {
  const EditarProductosWidget({
    super.key,
    required this.paramProducto,
  });

  final ProductosRecord? paramProducto;
...
class _EditarProductosWidgetState extends State<EditarProductosWidget> {
  ...
  void initState() {
    ...
    _model.txtIdTextController ??= TextEditingController(
        text: widget.paramProducto?.productoId.toString());
    _model.txtIdFocusNode ??= FocusNode();

    _model.txtNombrePTextController ??=
        TextEditingController(text: widget.paramProducto?.nombreProducto);
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              widget.paramProducto!.imagenProducto,
                              width: 200.0,
                              height: 200.0,
                              fit: BoxFit.cover,
                            ),
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .txtNombrePTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          ...
                          onPressed: () async {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                ...
                                backgroundColor: const Color(0xFF52C15B),
                              ),
                            );
                            context.safePop();
                          },
